    ...
    <section id="testimonios" className="py-16 bg-gray-50">
      ...
      <div className="flex overflow-x-auto space-x-6 pb-4 px-6 md:px-12 snap-x snap-mandatory scrollbar-hide">
        {testimonios.map((t, index) => (
          ...
          >
            <Card className="min-w-[320px] max-w-sm p-6 bg-white shadow-lg rounded-lg border border-gray-200">
              ...
              {/* Comentario */}
              <p className="text-gray-800 italic text-center">&ldquo;{t.comentario}&rdquo;</p>

              {/* Nombre */}
              <p className="mt-3 font-semibold text-sm text-center text-secondary">
                - {t.nombre}
              </p>
            </Card>
          </motion.div>
